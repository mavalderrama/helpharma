...
dlqi_set = (
    df_indicators[~df_indicators["dlqi"].isnull()][["id", "fecha_consulta", "dlqi"]]
    .sort_values(["id", "fecha_consulta"], ascending=False)
    .drop_duplicates(["id"])["dlqi"]
    .astype("float")
)
...
pasi_set = (
    df_indicators[~df_indicators["pasi"].isnull()][["id", "fecha_consulta", "pasi"]]
    .sort_values(["id", "fecha_consulta"], ascending=False)
    .drop_duplicates(["id"])["pasi"]
    .astype("float")
)
...
pga_set = (
    df_indicators[~df_indicators["pga"].isnull()][["id", "fecha_consulta", "pga"]]
    .sort_values(["id", "fecha_consulta"], ascending=False)
    .drop_duplicates(["id"])["pga"]
    .astype("float")
)
