        ...
        html.Div(
            [
                ...
                html.Div(
                    [
                        html.H6(
                            "DLQI Mean (of " + str(dlqi_count) + ")", className="bold"
                        ),
                        html.H5(
                            id="dlqi_mean",
                            children=dlqi_mean,
                ...
                html.Div(
                    [
                        html.H6(
                            "PASI Mean (of " + str(pasi_count) + ")", className="bold"
                        ),
                        html.H5(
                            id="pasi_mean",
                            children=pasi_mean,
                ...
                html.Div(
                    [
                        html.H6(
                            "PGA Mean (of " + str(pga_count) + ")", className="bold"
                        ),
                        html.H5(
                            id="pga_mean", children=pga_mean, className="centered bold"
                        ),
                    ],
